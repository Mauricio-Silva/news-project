...
<main>
    <div class="logo">
        <img src="static/images/ifms-logo.png" alt="ifms-logo">
    </div>
    <section>
        <div class="column">
            <div class="card">
        ...
        <div class="column">
            ...
            <a class="card card-link" href="http://localhost:80/news">
                <div>
                    <div class="icon">
                        <img src="static/icons/news.svg" alt="">
                    </div>
                    <h2>Projeto CRUD Notícias</h2>
                    <p>
                        Site construído com Laravel que implementa as operações CRUD 
                        e apresenta as informações como em um portal de notícias.
                    </p>
                </div>
